function sound_sniper_fire(){
    ...
    if (in_camera_view && !audio_is_playing(shoot_sound)) {
        ...
        shoot_sound = audio_play_sound_at(snd_shoot_02, adjusted_obj_x, obj_y - cam_center_y, 0, falloff_ref, falloff_max, falloff_factor, 0, 10, 1, 0, random_range(0.95,1.15));
