...
var ShadowXOffset = ShadowWidth - 10;
var ShadowYOffset = yOffset + ShadowHeight + 11;
draw_sprite(spr_shadow, 0, x + ShadowXOffset, y + ShadowYOffset);

// Icon
var iconWidth = sprite_get_width(ico_red_pyro);
var iconHeight = sprite_get_height(ico_red_pyro);
var iconXOffset = -iconWidth / 2;
var iconYOffset = yOffset - iconHeight - 5;
draw_sprite(ico_red_pyro, 0, x + iconXOffset, y + iconYOffset);

// Burning? might remove as pyros cannot catch on fire by default
if (isBurning = true) {
