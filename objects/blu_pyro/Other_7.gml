...
if (in_camera_view && !audio_is_playing(walk_sound_instance)) {
    ...
    walk_sound_instance = audio_play_sound_at(snd_walk, adjusted_obj_x, obj_y - cam_center_y, 0, falloff_ref, falloff_max, falloff_factor, 0, 10, 1, 0, random_range(0.75,0.9));
