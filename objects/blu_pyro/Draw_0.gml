...
// Icon
var iconWidth = sprite_get_width(ico_blu_pyro);
var iconHeight = sprite_get_height(ico_blu_pyro);
var iconXOffset = -iconWidth / 2;
var iconYOffset = yOffset - iconHeight - 5;
draw_sprite(ico_blu_pyro, 0, x + iconXOffset, y + iconYOffset);


// Burning? might remove since by defauly pyros cannot burn
if (isBurning = true) {
