...
// Icon
var iconWidth = sprite_get_width(ico_red_soldier);
var iconHeight = sprite_get_height(ico_red_soldier);
var iconXOffset = -iconWidth / 2;
var iconYOffset = yOffset - iconHeight - 5;
draw_sprite(ico_red_soldier, 0, x + iconXOffset, y + iconYOffset);
