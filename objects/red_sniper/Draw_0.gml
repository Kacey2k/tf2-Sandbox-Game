...
// Icon Placement
var iconWidth = sprite_get_width(ico_red_sniper);
var iconHeight = sprite_get_height(ico_red_sniper);
...
if (scoped) {
    draw_sprite(ico_red_sniper_scoped, floor(icon_frame), x + iconXOffset, y + iconYOffset);
} else {
    draw_sprite(ico_red_sniper, floor(icon_frame), x + iconXOffset, y + iconYOffset);
}
