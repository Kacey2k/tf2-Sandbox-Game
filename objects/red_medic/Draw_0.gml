...
//Icon
var iconWidth = sprite_get_width(ico_red_medic);
var iconHeight = sprite_get_height(ico_red_medic);
var iconXOffset = -iconWidth / 2;
var iconYOffset = yOffset - iconHeight - 5;
draw_sprite(ico_red_medic, 0, x + iconXOffset, y + iconYOffset);
...
if (isUbered) || (isUberedByOtherMedic) {
...
// UBER BAR
draw_set_color(c_black);
draw_rectangle(x + xOffset, y + yOffset - 2, x + xOffset + barWidth, y + yOffset - 2 + barHeight, false);
var uberPercentage = uberPoint / uberPointMax;
draw_set_color(c_aqua);
draw_rectangle(x + xOffset, y + yOffset - 2, x + xOffset + barWidth * uberPercentage, y + yOffset - 2 + barHeight, false);